...
class Student:
    def __init__(self,root):
        ...
        bg_img.place(x=0,y=30,width=1530,height=710)
        ...
        current_course_frame.place(x=5,y=35,width=720,height=120)
        ...
        dep_combo["values"]=("Select Department","Computer","Civil","Mechanical","IT")
        dep_combo.current(0)
        dep_combo.grid(row=0,column=1,padx=2,pady=10,sticky=W)


        # courses
        course_label = Label(current_course_frame,text='Program',font=("times new roman",12,"bold"),bg="white")
        ...
        course_combo["values"]=("Select Program","CS","ES","Arc","BE",)
        ...
        class_student_frame.place(x=5,y=190,width=720,height=300)
        ...
        class_div_combo.grid(row=1,column=1,padx=2,pady=8,sticky=W)
        ...
        # Address
        phone_label = Label(class_student_frame,text='Address',font=("times new roman",12,"bold"),bg="white")
        ...
        # Teacher Name
        phone_label = Label(class_student_frame,text='Teacher Name',font=("times new roman",12,"bold"),bg="white")
        phone_label.grid(row=4,column=2,padx=10,pady=5,sticky=W)

        phone_entry = ttk.Entry(class_student_frame,textvariable=self.var_teacher,width=20,font=("times new roman",12,"bold"))
        ...
        btn_frame.place(x=0,y=205,width=715,height=38)
...
#         ====================TABLE FRAME --------------------------
        ...
        table_frame.place(x=5,y=10,width=700,height=610)
        ...
        self.student_table.column("dep",width=100)    # by this way we can set the width of each column
    ...
    def get_cursor(self,event=""):
        coursor_focus = self.student_table.focus()
        content = self.student_table.item(coursor_focus)
        data = content['values']
    ...
    def delete_data(self):
        if self.var_std_id.get()=="":
            ...
            try:
                delete = messagebox.askyesno("Student Delete WIndow","Sure to delete this student details?",parent=self.root)
                if delete>0:
                    conn = mysql.connector.connect(host='localhost',username='root',password='Mysql@123database',database='attendencesystem')
                    my_cursor = conn.cursor()
    ...
    def generate_dataset(self):
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                ...
                messagebox.showinfo("Result","Generating datasets completd ")
